#! /bin/sh
#export <line 4-8> to set environment variable
DISA=/mnt/c/intern/deepintent/IconWidgetAnalysis/Static_Analysis
SDK=/mnt/c/Users/ASUS/AppData/Local/Android/Sdk
APK=/mnt/c/intern/deepintent/data/example/benign
SQL="jdbc:mysql://127.0.0.1:3306/cc?user=root&password=&serverTimezone=GMT"
